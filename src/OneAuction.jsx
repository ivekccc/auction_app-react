...
function OneAuction({ auction, logedUser, isActive, currency, exchangeRate }) {
    ...
    <div className="card">
      ...
      <div className="card-body">
        <div className="cardUpperPart">
          <div className="cardUpperPartContent">
            <h5 className="card-title">CategoryID: {auction.category_id}</h5>
            <p className="card-text">Started: {auction.start}</p>
            <p className="card-text">Ends: {auction.end}</p>
            <p className='card-text'>
              Current Price: {(auction.current_price * exchangeRate).toFixed(2)} {currency}
            </p>
          </div>
